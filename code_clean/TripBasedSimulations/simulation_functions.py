...
def plot_Tn_curve(sims, save = None):
    ...
    ax.annotate(s='x', xy =(0.01, ((keq_0-y_bounds[0])/(y_bounds[1]-y_bounds[0]))), xycoords='axes fraction', verticalalignment='center', horizontalalignment='left' , rotation = 0)
    ax.annotate(s='y', xy =(0.01, ((keq_1-y_bounds[0])/(y_bounds[1]-y_bounds[0]))), xycoords='axes fraction', verticalalignment='center', horizontalalignment='left' , rotation = 0)
    ax.annotate(s='z', xy =(0.01, ((keq_2-y_bounds[0])/(y_bounds[1]-y_bounds[0]))), xycoords='axes fraction', verticalalignment='center', horizontalalignment='left' , rotation = 0)
